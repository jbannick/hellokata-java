public class HelloDataTypesInteger {
    public static void main(String... args) {
        ...
        Byte by1 = (byte) -128;
        int in10x = by1.intValue();
        Short sh1 = -32768;
        int in10b = sh1.intValue();
        Long lo1 = -2147483648L;
        int in10c = lo1.intValue();
        Float fl1 = -2147483648.0f;
        int in10d = fl1.intValue();
        Double db1 = -2147483648.0d;
        int in10e = db1.intValue();
        ...
        int in25 = (int) lo2;
        float fl2 = -2147483648.0f;
        int in26 = (int) fl2;
        double db2 = -2147483648.0d;
        int in27 = (int) db2;
