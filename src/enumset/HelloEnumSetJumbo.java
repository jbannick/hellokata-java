...
public class HelloEnumSetJumbo {
    ...
    public enum Elements {
        ...
        Es, Fm, Md, No, Lr, Rf, Db, Sg, Bh, Hs, Mt, Ds, Rg, Cn, Nh, 
        Fl, Mc, Lv, Ts, Og
    }

    public static void main(String... args) {
        System.out.println("Hello EnumSet Jumbo!");

        EnumSet<Elements> eSet = EnumSet.allOf(Elements.class);
