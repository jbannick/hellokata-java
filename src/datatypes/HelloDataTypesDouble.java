public class HelloDataTypesDouble {
	public static void main(String...args) {
		...
		Byte    by1 = (byte) -128;               double db10x = by1.doubleValue();
		Short   sh1 = -32768;                    double db10b = sh1.doubleValue();
		Integer in1 = -2147483648;               double db10c = in1.doubleValue();
		Long    lo1 = -9223372036854775808L;   	double db10d = lo1.doubleValue();
		Float   fl1 = -3.4028235E38f;            double db10e = fl1.doubleValue();
...
//		The method decode() is not available for Double;
		...
		// 6. Value By Cast
		byte   by2 = (byte)  -128;   		       double db23 = (double) by2;
		short  sh2 = (short) -32768; 		       double db24 = (double) sh2;
		int    in2 = (int)   -2147483648; 		   double db25 = (double) in2;
		long   lo2 = (long)  -9223372036854775808L; double db26 = (double) lo2;
		float  fl2 = 1.4E-45f;                      double db27 = (double) fl2;
