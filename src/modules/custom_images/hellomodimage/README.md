...
a. An image directory tree, appmod-image, that contains your application, as a module, and the subset of the Java runtime environment necessary to run that app  
