	enum Bills {
		...
		private Bills(int value) {
			this.value = value;
			switch(this.value) {
			case 1:	this.desc = "buck"; break;
			case 5:	this.desc = "fin"; break;
			case 10:	this.desc = "sawbuck"; break;
			case 25:	this.desc = "Jackson"; break;
			}
		}
...
public class HelloEnumsAccessControl {
	...
	enum Coins {
		...
		private Coins(int value) {
			this.value = value;
			switch(this.value) {
			case 1:	this.desc = "penny"; break;
			case 5:	this.desc = "nickle"; break;
			case 10:	this.desc = "dime"; break;
			case 25:	this.desc = "quarter"; break;
			}
		}
	}
...
//		System.out.printf("bill.desc = %s\n", Bills.FIVE.desc); 
		...
		System.out.printf(
			"Before setting description, Bills.FIVE.getDescription() = %s\n", 
			desc07);
		
		String desc08 = bill.getDescription();
		System.out.printf(
			"Before setting description, bill.getDescription() = %s\n", 
			desc08);
		...
		System.out.printf(
			"After setting descriptionl, Bills.FIVE.getDescription() = %s\n", 
			desc09);
		
		String desc10 = bill.getDescription();
		System.out.printf(
			"After setting description,  bill.getDescription() = %s\n", 
			desc10);
	}
}
