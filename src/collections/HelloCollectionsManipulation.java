...
public class HelloCollectionsManipulation {
	...
	public static void main(String...args) {
		...
		System.out.println("---------------");
		Collections.reverse(listBytes); System.out.println(listBytes);
		System.out.println("---------------");
		Collections.swap(listBytes, 0, 3); System.out.println(listBytes);
		System.out.println("---------------");
		Collections.copy(listBytes, Arrays.asList(bytes2)); System.out.println(listBytes);
		System.out.println("---------------");
		
		//TODO: ADD, REMOVE, WHAT ELSE???
		// Can not change the count of elements in a list that is a REFERENCE to an array
