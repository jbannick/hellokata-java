public class HelloDataTypesFloat {
    public static void main(String... args) {
        ...
        Byte by1 = (byte) -128;
        float fl10x = by1.floatValue();
        Short sh1 = -32768;
        float fl10b = sh1.floatValue();
        Integer in1 = -2147483648;
        float fl10c = in1.floatValue();
        Long lo1 = -9223372036854775808L;
        float fl10d = lo1.floatValue();
        Double db1 = -9223372036854775808.0d;
        float fl10e = db1.floatValue();
